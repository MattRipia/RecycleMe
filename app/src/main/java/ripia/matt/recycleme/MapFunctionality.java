...
*
* */
    public class MapFunctionality extends AppCompatActivity implements OnMapReadyCallback, GoogleApiClient.OnConnectionFailedListener{
        ...
        private void init(){
            ...
            mPlacePicker.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    try {
                        startActivityForResult(builder.build(MapFunctionality.this), PLACE_PICKER_REQUEST);
        ...
        private void geoLocate(){
            ...
            Geocoder geocoder = new Geocoder(MapFunctionality.this);
                    ...
                    location.addOnCompleteListener(new OnCompleteListener() {
                        ...
                        public void onComplete(@NonNull Task task) {
                            if(task.isSuccessful()){
                                ...
                                Toast.makeText(MapFunctionality.this, "unable to get current location", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                }
        ...
        private void moveCamera(LatLng latLng, float zoom, PlaceInfo placeInfo){
            ...
            mMap.setInfoWindowAdapter(new CustomInfoWindowAdapter(MapFunctionality.this));
        ...
        private void initMap(){
            ...
            mapFragment.getMapAsync(MapFunctionality.this);
        }
